...
struct TVBookTimelineTests {
    ...
    /// Without a clock that can tell chapters inside one file apart, they all
    /// land on that file's start — seventeen marks in four places, four of them
    /// stacked into a blot.
    ...
    func dedupesEqualFractions() throws {
        let package = try Self.package(
            ...
            weights: [1, 1],
            navigation: [
                Self.nav("One", "a.xhtml", fragment: "x1"),
                Self.nav("Two", "a.xhtml", fragment: "x2"),
                Self.nav("Three", "a.xhtml", fragment: "x3"),
